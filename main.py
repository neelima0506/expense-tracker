...
while True:
    ...
    print("1. Enter a newexpense")
    print("2. View expenses summary")

    choice = int(input())

    if choice == 1:
        date = input("Enter the date of the espense (YYYY-MM-DD): ")
        ...
        print("Selecct a category by number:")
        ...
        price = input("Enter the price of the espense:")
